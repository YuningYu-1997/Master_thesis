# This script is to training the model with df loss with custom dataset
import os
...
def train(train_loader, model, criterion, optimizer, num, accumulation_steps, use_gpu):
    losses = 0 #loss value
    right_sum = 0 #number of right orediction
    jcn = 0 #value of jcn similarity
    wp = 0 #value of wup similarity
    trained_num = 0 #number of samples which get trained
