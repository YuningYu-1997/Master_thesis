# this script is to train the pretrained model by cross-entropy loss, to compare with other loss function
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name',default = 'resnet18pre_continue', type=str, help='Name of the saved file')
    ...
    earlystopping = EarlyStopping(tolerence = 5, type = 'acc')
