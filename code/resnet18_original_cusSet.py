# This script is to training the model with traditional cross-entropy loss with my custom dataset, to compare with the deep feature loss with custom dataset 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name',default = 'resnet18_original_cusSet', type=str, help='Name of the saved file')
