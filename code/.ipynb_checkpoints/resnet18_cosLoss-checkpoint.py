# This script is to training the model with df loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name',default = 'resnet18_cosloss', type=str, help='Name of the saved file')
    ...
    for epoch in range(args.start_epoch, args.end_epochs):
        ...
        if (epoch+1)%20==0:
            ...
            torch.save(checkpoint, '../checkpoint/%s_%s.pth' % (args.name, str(epoch)))
