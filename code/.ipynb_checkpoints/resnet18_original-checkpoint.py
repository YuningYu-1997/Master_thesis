# This script is to training the model with traditional cross-entropy loss
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('--accumulation_steps', default = 2, type=int, help = 'Accumulation step')
    ...
    parser.add_argument('--name',default = 'resnet18_original_wpStop', type=str, help='Name of the saved file')
