...
class customLoss(torch.nn.Module):
    ...
    def __init__(self, lamda=1, margin=0.1):
    ...
    def forward(self, output, df, target):
        ...
        Sim_sum = torch.sum(torch.multiply(wp_Sim_3, torch.abs(torch.pow(wp_Sim - cos_Sim,3))))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name',default = 'resnet18_cosloss_3*1^3_cusSet', type=str, help='Name of the saved file')
